...
public class KeywordsFeatureVectorGenerator implements FeatureVectorGenerator {
    ...
    public Map<List<Integer>, WebpageClass> getFeatureVectors(Map<File, WebpageClass> trainingFiles) throws Exception {
    	...
    	Map<List<Integer>, WebpageClass> result = generateVector(topWords_course,topWords_student,topWords_faculty,trainingFiles);
    	
    	
    	
        return result;
    }
    private static Map<List<Integer>, WebpageClass> generateVector(List<String>topWords_course,List<String>topWords_student, List<String>topWords_faculty,Map<File, WebpageClass> trainingFiles ) throws IOException{
